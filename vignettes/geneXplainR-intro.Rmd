...
to carry out a single type of task. Usually, a data analysis consists of many steps invoking various tools
...
An easy way to find out about the available workflows is to use the *gx.ls* function, which lists contents of a
...
gx.ls("analyses/Workflows/Common/Analyze any DNA sequence, GeneBank")

# Invoke workflow
gx.workflow("analyses/Workflows/Common/Example workflow", list(exampleParameter="value1"))
```
